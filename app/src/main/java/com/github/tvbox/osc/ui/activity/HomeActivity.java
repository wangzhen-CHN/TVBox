                ...
                if (view != null) {
                    mHandler.postDelayed(new Runnable() {
                        ...
                        public void run() {
                            ...
                            textView.setTextColor(HomeActivity.this.getResources().getColor(sortFocused == p ? R.color.color_FFFFFF : R.color.color_FFFFFF_70));
                            textView.invalidate();
                        }
...
//        });
        ...
        // Button : History >> To go into History --------------------
...
//                    changeTop(sortFocused != 0);
    ...
    private void setTopFocusable(boolean isFocusable) {
        tvFind.setFocusable(isFocusable);
        tvSetting.setFocusable(isFocusable);
        tvFavorite.setFocusable(isFocusable);
        tvHistory.setFocusable(isFocusable);
    }
